 ...
 * NOTE: stationID và pinID không còn được lưu vào database nữa (kept for
...
public class VNPayPaymentDTO {
    ...
    public VNPayPaymentDTO(Integer packID, Integer paymentID, Long amount, String updatedAt, Integer total,
            Integer userID) {
        this.packID = packID;
        ...
        this.total = total;
        this.status = 1; // Successful
        this.userID = userID;
    }

    // Constructor for payment history with status - NEW
    public VNPayPaymentDTO(Integer packID, Integer paymentID, Long amount, String updatedAt, Integer total,
    ...
    @Deprecated
    public VNPayPaymentDTO(Integer userID, Integer packID, String orderInfo, Long amount, Integer stationID,
            Integer pinID) {
        this.userID = userID;
        this.packID = packID;
        this.vnp_OrderInfo = orderInfo;
    ...
    // Constructor for transaction history (recommended - without deprecated
    // stationID/pinID)
    ...
    // Constructor for payment history (packID, txnRef, orderInfo, amount, bankCode,
    // status, createdAt)
    public VNPayPaymentDTO(Integer packID, String vnp_TxnRef, String vnp_OrderInfo, Long vnp_Amount,
            String vnp_BankCode, int status, String createdAt) {
        this.packID = packID;
    ...
    public Double getAmountVND() {
        return vnp_Amount != null ? vnp_Amount.doubleValue() : 0.0;
    }

    public void setAmountVND(Double amountVND) {
        this.vnp_Amount = amountVND != null ? Math.round(amountVND) : 0L;
    }
