...
public class PinSlotDTO {
    ...
    private Integer vehicleID; // vehicleID cho chức năng reserve
    ...
    public PinSlotDTO(int pinID, int pinPercent, int pinStatus, int status, Integer userID, Integer vehicleID) {
        this.pinID = pinID;
    ...
    // Constructor with userID, vehicleID and stationID
    public PinSlotDTO(int pinID, int pinPercent, int pinStatus, int status, Integer userID, Integer vehicleID, int stationID) {
        this.pinID = pinID;
        this.pinPercent = pinPercent;
        this.pinStatus = pinStatus;
        this.pinHealth = 0; // Default value
    ...
    public PinSlotDTO(int pinID, int pinPercent, int pinHealth, int pinStatus, int status, Integer userID, Integer vehicleID, int stationID) {
        this.pinID = pinID;
        this.pinPercent = pinPercent;
