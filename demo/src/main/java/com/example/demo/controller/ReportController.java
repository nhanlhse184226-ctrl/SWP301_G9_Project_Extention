...
public class ReportController {
    ...
    @Operation(summary = "Update report status", 
               description = "Admin updates report status and automatically becomes the handler. " +
    ...
    public ResponseEntity<ApiResponse<Object>> updateReportStatus(
            ...
            @Parameter(description = "New status: 0=Pending, 1=InProgress, 2=Resolved", required = true, example = "1")
